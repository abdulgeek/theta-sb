...
values ('u001', 'user001','$2a$10$8AfV.EkFEPh2OpqInI6r9.FT73nYeKe1bU6Lh.iLqOGnvNxDgXgGS', true, 'r001');

-- password : testmanager
insert into s_users (id, username, password, active, id_role)
values ('u002', 'user002', '$2a$10$RPB/8RrHOPBbUj0iYRy7hu7K2fMKEFIR5Cqb2oGyeKcRFY/sH0.Mi', true, 'r002');
